    ...
    function productFilterService(helper) {
              ...
              switch (filter.operator) {
                  ...
                  case '><':
                      ...
                      var mathOperator = filter.operator.substring(0, 1),
                          fieldValue = mathOperator === '*' ? _multiplyFields(product, fields) : _divideFields(product, fields),
          ...
          function _matchUsingOperator(operator, fieldValue, expression) {
              ...
              switch (operator) {
                  ...
                  default:
                      var singleOperator = operator.substring(1);
                      return _matchUsingSingleOperator(operator, fieldValue, expression);
              }
          };
          ...
          function _multiplyFields(product, fields) {
